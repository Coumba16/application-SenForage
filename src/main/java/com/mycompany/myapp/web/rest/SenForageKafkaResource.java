...
@RestController
@RequestMapping("/api/sen-forage-kafka")
public class SenForageKafkaResource {
    private final Logger log = LoggerFactory.getLogger(SenForageKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SenForageKafkaResource(KafkaProperties kafkaProperties) {
